...
name = "hello {} welcome to the general quiz"
...
#using while loops and if and else statments and also tells them that there wrong and the user can't type anything else other than the option they get
print(QUESTIONS[0])
...
#Final score
print("{}'s total score for the quiz is {} out of 10 ".format(user_name,score))
